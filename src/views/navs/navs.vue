  ...
  <div>
    <el-card class="box-card">
      ...
      <div>
        ...
        <el-button type="primary" @click="add(1)">添加导航</el-button>
      </div>
      <div>
        <!-- 表格 -->
        <el-table
        ...
        >
          ...
          <el-table-column align="center" prop="url" label="路径" width="400">
          </el-table-column>
...
let change = (row: any) => {
  api
    .showNav({ id: row._id, isShow: row.isShow })
    .then((res: any) => {
      if (res.code === 200) {
